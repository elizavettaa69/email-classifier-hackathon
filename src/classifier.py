    ...
    def _get_default_rules(self):
        return [
            ...
            ('incident', [
                ...
                'проблема не устранена', 'по-прежнему', 'не может подключиться', 
                'не может зарегистрироваться', 'жалоба', 'клиент'
            ]),
            ...
            ('access', [
                ...
                'перевод в отдел', 'уровни доступа', 'график работы','отпуск'
            ]),
            ...
            ('newsletters', [
                ...
                'встреча', 'напоминание', 'инструкция', 'подтвердить', 'финальная версия'
            ])
        ]
